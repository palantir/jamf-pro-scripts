...
###
#
#            Name:  Uninstall Polycom RealPresence Desktop.sh
#     Description:  Uninstalls Polycom RealPresence Desktop. Quits all running
...
resourceFiles=(
  "/Applications/Polycom RealPresence Desktop.app"
)
